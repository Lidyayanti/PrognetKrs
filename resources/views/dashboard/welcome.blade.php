    ...
    <div id="main">
        ...
        <header class="main-header dark-header fs-header sticky">
            <div class="header-inner">
                ...
                <span></span>
                <div href="dashboard-add-listing.html" class="add-list modal-open">Register <span><i
        ...
        <div id="wrapper">
            ...
            <div class="content">
                ...
                <section class="scroll-con-sec hero-section" data-scrollax-parent="true" id="sec1">
                    <div class="bg" data-bg="images/bg/mhs.jpg"
                    ...
                    <div class="container">
                        ...
                        <div class="row home-posts">
                            <div class="col-md-4">
                                <article class="card-post">
                                    <div class="card-post-img fl-wrap">
                                        <a href="blog-single.html"><img src="images/dashboard/koding.jpg" alt=""></a>
                                    </div>
                                    <div class="card-post-content fl-wrap">
                                        <h3><a href="blog-single.html">Pemrograman Internet</a></h3>
                                        <p>Mata kuliah Pemrograman Internet adalah mata kuliah yang akan membahas
                                            tentang konsep dasar aplikasi web dinamis. </p>
                                        <div class="post-author"><a href="#"><img src="images/avatar/1.jpg"
                                                    alt=""><span>By , I Nyoman Piarsa, ST., MT.</span></a></div>
                                    </div>
                                </article>
                            </div>
                            <div class="col-md-4">
                                <article class="card-post">
                                    <div class="card-post-img fl-wrap">
                                        <a href="blog-single.html"><img src="images/dashboard/database.png" alt=""></a>
                                    </div>
                                    <div class="card-post-content fl-wrap">
                                        <h3><a href="blog-single.html">Teknologi Basis Data</a></h3>
                                        <p>Matakuliah ini mempunyai prasyarat sistem basis data.
                                            Dalam matakuliah ini mahasiswa diberikan pemahaman tentang bagaimana
                                            Sistem Manejemen Basis datamelakukan pemrosesan dalam query, melakukan
                                            optimasi
                                            query dengan pemrograman SQL sehingga dpat meningkatkan kinerja dari
                                            database. </p>
                                        <div class="post-author"><a href="#"><img src="images/avatar/1.jpg"
                                                    alt=""><span>By , I Nyoman Piarsa, ST., MT.</span></a></div>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <article class="card-post">
                                    <div class="card-post-img fl-wrap">
                                        <a href="blog-single.html"><img src="images/dashboard/jarkom.png" alt=""></a>
                                    </div>
                                    <div class="card-post-content fl-wrap">
                                        <h3><a href="blog-single.html">Jaringan Komputer</a></h3>
                                        <p>Mata kuliah ini dimaksudkan supaya mahasiswa dapat memiliki pengetahuan,
                                            pemahaman untuk : memahami dan membangun jaringan komputer dengan
                                            menggunakan protokol TCP/IP,
                                            Memahami teknik dan penyelesaian masalah terhadap aplikasi rangkaian yang
                                            meliputi konsep,
                                            istilah dan implementasi jaringan komputer. </p>
                                        <div class="post-author"><a href="#"><img src="images/avatar/1.jpg"
                                                    alt=""><span>By , I Nyoman Piarsa, ST., MT.</span></a></div>
                                    </div>
                                </article>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="color-bg-text">
                                    ...
                                    <p>Sistem kami menggunakan server tercepat dan mumpuni untuk melayani penanganan KRS
                                        adik-adik mahasiswa, sehingga proses pengisian KRS dapat dilakukan dengan cepat,
                                        terintegrasi, efektif, efisien dan akurat</p>
                    ...
                    <div class="container">
                        <div class="join-wrap fl-wrap">
                            <div class="row">
                                ...
                                <div class="col-md-4"><a href="contacts.html" class="join-wrap-btn">Get In
                                        Touch <i class="fa fa-envelope-o"></i></a></div>
                            </div>
                        </div>
                    </div>
                </section>
